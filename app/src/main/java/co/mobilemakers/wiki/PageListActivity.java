...
public class PageListActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            String projectId = getIntent().getStringExtra(PageListFragment.CATEGORY);
            Bundle bundle = new Bundle();
            bundle.putString(PageListFragment.CATEGORY, projectId);
            pageListFragment.setArguments(bundle);
            getSupportFragmentManager().beginTransaction()
                    .add(R.id.container, pageListFragment)
                    .commit();
        }
    }
